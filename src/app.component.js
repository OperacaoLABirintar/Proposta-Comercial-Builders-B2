...
class ProgramComponent {
  ...
  selectedExperiencia = signal(this.experiencias[0]);
  selectExperiencia(exp) { this.selectedExperiencia.set(exp); }
}
...
class PricingComponent {
  ...
  selectTier(tier) { this.selectedTier.set(tier); }
